...
coords = [
  ...
  function recupCoords(){

  }

*/

  function RecupCoord(){ //appel de la liste avec tous les feux
...
function displayJourneyReshaped(body) {
  ...
  //displayJourneyReshaped(trajet);

/*

function displayiti (trajet) {
        var pointList = [];
        trajet.forEach(trajets => {
        pointList.push(new L.LatLng(trajets.lat, trajets.lon));
        });
